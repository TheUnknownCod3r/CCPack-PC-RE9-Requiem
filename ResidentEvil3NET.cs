...
namespace CrowdControl.Games.Packs.ResidentEvil3NET;

public class ResidentEvil3NET : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public ResidentEvil3NET(UserRecord player, Func<CrowdControlBlock, bool> responseHandler, Action<object> statusUpdateHandler) : base(player, responseHandler, statusUpdateHandler) { }

    public override Game Game { get; } = new("Resident Evil 3", "ResidentEvil3NET", "PC", ConnectorType.SimpleTCPServerConnector);
