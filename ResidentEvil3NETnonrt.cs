...
namespace CrowdControl.Games.Packs.ResidentEvil3NETnonrt;

public class ResidentEvil3NETnonrt : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public ResidentEvil3NETnonrt(UserRecord player, Func<CrowdControlBlock, bool> responseHandler, Action<object> statusUpdateHandler) : base(player, responseHandler, statusUpdateHandler) { }

    public override Game Game { get; } = new("Resident Evil 3", "ResidentEvil3NETnonrt", "PC", ConnectorType.SimpleTCPServerConnector);
