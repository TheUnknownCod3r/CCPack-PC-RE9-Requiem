...
namespace CrowdControl.Games.Packs.ResidentEvil3DX11;

public class ResidentEvil3DX11 : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public ResidentEvil3DX11(UserRecord player, Func<CrowdControlBlock, bool> responseHandler, Action<object> statusUpdateHandler) : base(player, responseHandler, statusUpdateHandler) { }

    public override Game Game { get; } = new("Resident Evil 3", "ResidentEvil3DX11", "PC", ConnectorType.SimpleTCPServerConnector);
